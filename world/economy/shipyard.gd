...
##
## Rumpf und Segel, sonst nichts. Angeheuert wurde hier von M4 bis M6 auch -
## der Kommentar an dieser Stelle sagte selbst, dass es nicht hierher gehoert.
## Es steht jetzt dort, wo es hingehoert, in der [Tavern].
class_name Shipyard
extends RefCounted
